...
public class OrderServiceImpl implements OrderService {
  ...
  public OrderDto getOrder(Long id) {
    Order targetOrder = orderRepository.findById(id).orElseThrow(IllegalArgumentException::new);
  ...
  public List<OrderDto> getOrderList() {
    return orderRepository.findAll().stream().map(this::convertOrder).collect(Collectors.toList());
  }
